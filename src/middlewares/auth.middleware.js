...
export const validateProjectPermission = (roles = []) => asyncHandler(async (req,res,next)=>{
    ...
    if(!projectId) throw new ApiError(401,"Invalid Project id")
    ...
    if(!roles.includes(givenRole)) throw new ApiError(403,"You do not have permission to perfome this action")
